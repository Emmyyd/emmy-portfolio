...
const projects = [
  { icon: Globe, title: "Project 1", description: "Working on it..." },
  { icon: LayoutGrid, title: "Project 2", description: "Working on it..." },
  { icon: Settings, title: "Project 3", description: "Working on it..." },
  { icon: ImageIcon, title: "Project 4", description: "Working on it..." },
]
